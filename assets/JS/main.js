...
button.addEventListener('click', (evt) => {
    ...
    if(name === '' || email === '' | message === ''){
        ...
        ui.showAlert('🤣 Hei! Your name must be > 6 chars and only alphabets', 'error');
        var targetElement = document.querySelector('.container');
        targetElement.scrollIntoView({behavior: "smooth", block: "end", inline: "nearest"});
    }

    else{
        window.open('mailto:nathanaelfredericko@gmail.com?subject=Mail From '+name+'&body='+message+' \nFrom : '+email);
        ...
        document.getElementById('wait').style.display = "block";
            ...
            setTimeout(function (){
                ...
                ui.showAlert('You can send the email now, Thanks! 👍', 'success')
                var targetElement = document.querySelector('.container');
                targetElement.scrollIntoView({behavior: "smooth", block: "end", inline: "nearest"});
        ...
        //     To: "nathanaelfredericko@gmail.com",
        //     From: `${email}`,
        //     Subject: `📧 An email from ${name}`,
        //     Body: `Hello nathfred👋, there a message from your viewers. <br> <br> 🧑🏻 A Name : ${name} <br> ✉️ A Message : <br><br> 
        //     ${message} <br><br> Write on ${days[d.getDay()] + ', ' + months[d.getMonth()] + ' ' + d.getDate() + ' ' + d.getFullYear() + ' ' + hours + ':' + minutes + ' ' + ampm}`,
        // }).then((message) => {
        ...
        //     setTimeout(function (){
        //         document.getElementById('wait').style.display = "none";
        //         ui.showAlert('👍 Thanks! Your message was successfully sent.', 'success')
        //         var targetElement = document.querySelector('.container');
        //         targetElement.scrollIntoView({behavior: "smooth", block: "end", inline: "nearest"});
